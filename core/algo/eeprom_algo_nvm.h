/**
  ******************************************************************************
  * @file    eeprom_emulation/core/algo/eeprom_algo_nvm.h
  * @brief   This file contains all the functions prototypes for the nvm algo EEPROM
...
#ifndef EEPROM_ALGO_NVM_H
#define EEPROM_ALGO_NVM_H
...
/** @defgroup EEPROM_EMULATION_ALGO_NVM Algo NVM
  * @{
  */
...
/** @defgroup EEPROM_EMULATION_ALGO_NVM_EXPORTED_FUNCTIONS Algo NVM Exported Functions
  * @{
  */
